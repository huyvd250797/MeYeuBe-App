# Acceptance Criteria — MeYeuBe V13.4.2
...
| 10.4 | Không sửa hàm nào thuộc Baseline Lock | 26/26 khớp `BASELINE_LOCK_V13.4.1` | ✅ |
...
## 14. V13.4.2 — Chỉ cho chọn bình/túi đang ở trạng thái "Đang dùng"

| # | Tiêu chí | Cách kiểm tra | Kết quả |
|---|----------|---------------|---------|
| 14.1 | Form Hút sữa chỉ hiện mục Đang dùng | 2 mục Đang dùng hiện, 2 mục Tạm ẩn biến mất | ✅ |
| 14.2 | Đổi sang Tạm ẩn thì biến mất ngay | Sửa trong Danh mục → mở lại form → không còn | ✅ |
| 14.3 | Popup Chuyển sữa: đích loại Bình chỉ hiện bình Đang dùng | ✅ |
| 14.4 | Popup Chuyển sữa: đích loại Túi chỉ hiện túi Đang dùng | ✅ |
| 14.5 | Chặn cả khi gọi thẳng vào mục đang ẩn | `tfPickTarget('binh_off')` → không nhận | ✅ |
| 14.6 | Chặn chọn mục ẩn ở form Hút sữa | Có thông báo, giá trị không đổi | ✅ |
| 14.7 | Bản ghi cũ dùng mục nay bị ẩn: mở Sửa vẫn giữ nguyên | Không âm thầm mất dữ liệu | ✅ |
| 14.8 | Mục đó hiện mờ, viền đứt nét, gắn nhãn “Tạm ẩn” | ✅ |
| 14.9 | Ghi nhận mới thì mục ẩn không xuất hiện | ✅ |
...
| 14.12 | Trang Danh mục vẫn liệt kê đầy đủ để bật lại được | ✅ |
| 14.13 | Hai chỗ chọn dùng chung một helper | `mcSelectableList()` — hành vi không lệch nhau | ✅ |

```
[1] Form Hút sữa                    7/7 PASS
[2] Popup Chuyển sữa                6/6 PASS
[3] Bản ghi cũ không mất dữ liệu    7/7 PASS
[4] Không ảnh hưởng chỗ khác        5/5 PASS
────────────────────────────────────────────
TỔNG                              25/25 PASS
