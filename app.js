...
var AX_PRESS_DELAY=62;   /* chờ ~62ms để phân biệt CHẠM (giữ yên) với CUỘN (di chuyển) */
var AX_PRESS_MOVE=10;    /* di quá 10px coi như cuộn → huỷ hiệu ứng nhấn */
var AX_PRESS_MINVIS=140; /* đã hiện thì giữ tối thiểu 140ms cho mắt kịp thấy */
