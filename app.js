...
function hb2Render(){
  ...
  root.innerHTML=hb2ChipsHtml(db)+hb2TabsHtml(m)+'<div class="hb2Body">'+fn(db,m)+'</div>'+hb2FabHtml();
  if(hb2State.view==='growth')hb2DrawChart(db,m);
}
function hb2ChipsHtml(db){
  var arr=hb2Members(db),act=(db.hb||{}).activeId;
  return '<div class="card hb2Head"><div class="hb2HeadTop"><h2>🩺 Sổ sức khỏe</h2>'+
    '<span class="hb2Ver">2.0</span></div><div class="hb2Chips">'+
    arr.map(function(m){
...
function hb2FabHtml(){return '<button class="hb2Fab" onclick="hb2OpenQuickAdd()" aria-label="Thêm nhanh">＋</button>'}
