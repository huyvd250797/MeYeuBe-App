...
/* ============================================================
   ...
   ============================================================ */
window.CCX = window.CCX || {style:{}, compare:{}, series:{}, _init:false, _tipT:null};
...
function ccxRenderAll(db){
  ...
  var range=careChartRange();
  var segBtns=document.querySelectorAll('#ccxSeg button'),i;
  ...
  var html='<p class="notice" style="margin:2px 2px 4px">'+esc(titleTxt)+' · Chạm cột/điểm để xem chi tiết.</p>';
  for(i=0;i<CCX_TYPES.length;i++){
    var t=CCX_TYPES[i];
    html+='<div class="ccxCard" id="ccxCard-'+t+'">'+
      '<div class="ccxPop" id="ccxPop-'+t+'"></div>'+
      '<div class="ccxHead" id="ccxHead-'+t+'"></div>'+
      '<div class="ccxQs" id="ccxQs-'+t+'"></div>'+
      '<div class="ccxPlotWrap"><div class="ccxScroll" id="ccxPlot-'+t+'"></div><div class="ccxLegend" id="ccxLeg-'+t+'"></div></div>'+
      '<div class="ccxIns" id="ccxIns-'+t+'"></div>'+
    '</div>';
  }
  target.innerHTML=html;
  for(i=0;i<CCX_TYPES.length;i++)ccxRenderOne(CCX_TYPES[i]);
}
