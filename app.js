...
function syncCareFormChromeForType(type){
  /* V15.0.7: Timer chỉ còn đúng một nút "Bắt đầu bú" và chỉ hiện trong form Bé bú.
...
function tl8Detail(id){
  ...
  h+='<div class="tl8RecordChipBar" aria-label="Gán chip và thao tác bản ghi">'+
...
/* ============================================================================
   V15.0.7 · FeedStatus TimelineUX — Timer bú + trạng thái + Timeline chip
   ============================================================================ */
(function(){
  var OPEN_SEL=[
    '.tl8Sheet.show','.tl8Overlay.show','.moreSheet.show','.streakOverlay.show',
...
/* V15.0.7 · TimerChipFix — compact timer + realtime feed + record chips */
