...
/* ============================================================================
   V15.0.3 · Boss patch — Khoá scroll nền cho TẤT CẢ bottom sheet
   ============================================================================ */
(function(){
  ...
  function patchTl8ShowHide(){
    if(window.tl8Show&&!window.__tl8ShowV1503){
      ...
      window.tl8Show=function(el){var r=window.__tl8ShowV1503.apply(this,arguments);schedule();return r};
    }
    if(window.tl8Hide&&!window.__tl8HideV1503){
      window.__tl8HideV1503=window.tl8Hide;
      window.tl8Hide=function(el){var r=window.__tl8HideV1503.apply(this,arguments);schedule();return r};
    }
  }
  function init(){
    patchTl8ShowHide();
