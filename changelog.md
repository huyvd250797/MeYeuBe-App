## V15.0.19 — CareTypoUI
- Đồng bộ typography cho form Thêm/Sửa chăm sóc và modal Xem chi tiết từng loại chăm sóc.
- Giảm chữ quá đậm ở meta/phụ, chỉ nhấn tiêu đề, số liệu chính và CTA.
- Chuẩn hóa label, input, chip, card summary và record list để các loại chăm sóc cùng format.

## V15.0.19 — PumpMilk24UI
...
## V15.0.19 — FeedStatus TimelineUX
