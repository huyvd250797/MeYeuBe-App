...
check('AC file exists', (root/'AC_V10.7.0.md').exists())
check('Version consistency', all('10.7.0' in (root/f).read_text(encoding='utf-8') for f in ['index.html','app.js','manifest.webmanifest','sw.js','version.md']))
