...
for f in ['index.html','app.js','manifest.webmanifest','sw.js','version.md']:
    if '11.7.0' not in (root/f).read_text(encoding='utf-8'): errors.append(f+' chưa đồng bộ version')

for required_file in ['AC_V11.7.0.md','BASELINE_LOCK_V11.7.0.json','PUSH_NOTIFICATION_SETUP.md','supabase/functions/send-push/index.ts']:
...
PREV_LOCK='BASELINE_LOCK_V11.6.0.json'
...
if errors:
    ...
    sys.exit(1)
print('RELEASE CHECK PASSED: V11.7.0')
