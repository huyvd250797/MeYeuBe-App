...
for f in ['index.html','app.js','manifest.webmanifest','sw.js','version.md']:
    if '13.4.2' not in (root/f).read_text(encoding='utf-8'): errors.append(f+' chưa đồng bộ version')

for required_file in ['AC_V13.4.2.md','BASELINE_LOCK_V13.4.2.json','PUSH_NOTIFICATION_SETUP.md','supabase/functions/send-push/index.ts']:
...
PREV_LOCK='BASELINE_LOCK_V13.4.1.json'
...
if errors:
    ...
    sys.exit(1)
print('RELEASE CHECK PASSED: V13.4.2')
